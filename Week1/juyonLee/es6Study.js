...
var myCat = new Cat("juyon");
myCat.hello(); //실행 결과: Mew~ I'm juyon
...
var myCheeseCat = new CheeseCat("juyon");
myCheeseCat.hello(); // 실행 결과: Cheese~ I'm juyon
...
users.map(user =>
  ...
  ////console.log로 출력하는 방법도 다시 고민해봐야겠다

users
  .filter(user => {return user.age >= 28;})
