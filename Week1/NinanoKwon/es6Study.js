...
var myCat = new Cat("ninano");

myCat.hello(); // "Mew~ I'm ninano"
...
var myCheeseCat = new CheeseCat("hahaha");

myCheeseCat.hello(); // "Cheese~ I'm ninano"
myCheeseCat.grooming(); // "groooming..."
...
04-2. (2) ["Bob, 30", "Dave, 28"]

04-3. (4) ["0, Alice, 18", "1, Bob, 30", "2, Carol, 22", "3, Dave, 28"]
